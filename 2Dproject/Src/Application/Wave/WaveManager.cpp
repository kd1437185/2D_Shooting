...
const WaveData WaveManager::WAVE_LIST[WAVE_COUNT] =
{
    ...
    { true,  false, false, false, AppConst::MOB_MAX_WAVE4, 0,                      0,                   1 }, // フェーズ4: MobEnemy
    { false, true,  true,  false, 0,                       AppConst::SHOOTER_MAX,  AppConst::TANK_MAX,  1 }, // フェーズ5: ShooterEnemy + TankEnemy同時
    { false, false, true,  false, 0,                       0,                      AppConst::TANK_MAX,  2 }, // フェーズ6: TankEnemy x2回
